...
export default function StartProjectPage() {
  return (
    <div className="space-y-10 sm:space-y-12 md:space-y-14">
      <section className="space-y-6 rounded-[32px] border border-border/75 bg-background p-5 sm:space-y-8 sm:p-7 md:p-8">
      ...
      <section className="rounded-[32px] border border-border/75 bg-background p-4 sm:p-5 md:p-6">
